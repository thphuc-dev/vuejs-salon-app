<template>
  <main class="app-content">
    <section class="content report-bookings-by-month-page">
      <div class="page-title">
        <h3>{{ $t('report.bookings-by-month') }}</h3>
        <ul class="group-btn">
...
export default {
  ...
  data(){
    return {
      ...
      table_data   : {
        fields : [
          {field: 'month',             label: 'general.month',            width: '20%',   sortable: false, expand: true },
  ...
  methods:{
    ...
    async loadTableDataAsync(){
      ...
      this.preLoader()
      let response = await this.report_api.getBookingsByMonthReportAsync(this.table_filter)
...
<style lang="scss">
@import './report-bookings-by-month.scss';
</style>
