<template>
  <main class="app-content">
    <section class="content report-service-sales-by-item-page">
      <div class="page-title">
        <h3>{{ $t('report.service-sales-by-item') }}</h3>
        <ul class="group-btn">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="select-filter">
                  ...
                  <!-- <div class="select-box report-by-type">
...
export default {
  ...
  data(){
    return {
      ...
      table_data   : {
        fields : [
          {field: 'name',         label: '',                      width: '45%',   sortable: false, expand: true, column_expand: true },
  ...
  methods: {
    ...
    async loadTableDataAsync(){
      ...
      this.preLoader()
      let response = await this.report_api.getServiceSalesByItemReportAsync(this.table_filter)
      this.preLoader(false)
...
<style lang="scss">
@import './report-service-sales-by-item.scss';
</style>